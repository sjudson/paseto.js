...
function generate(protocol) {
  ...
  if (protocol instanceof V1) { return new AsymmetricSecretKey(extcrypto.keygen(), protocol); };
...
function getPublicKey() {
  ...
  if (self.protocol instanceof V1) { return new PublicKey(extcrypto.extract(self.key), self.protocol); };
